...
<div class="Left-Box">
<center><h5 style="padding:0px; margin:0px;">Sell <?php echo $name; ?></h5></center>
...
document.getElementById('fee2').value = y;//Math.abs(y * (1  / 200)).toFixed(8);
	...
	<form action="index.php?page=trade&market=<?php echo $id; ?>" method="POST"> 
		<li>Amount <?phpecho $name;?>:<input type="text" style="width:100px;" name="amount" onKeyUp="calculateFees1(this)" id="Amount"/></li>
		<li>Price Per <?php echo $name;?>:<input type="text" style="width:100px;" name="price"  id="Value" /></li>
		<li>Total:<input type="text" style="width:100px;" id="fee"/><br/></li>
		<li><input type="submit" name="Sell" value="Sell"/></li>
	</form>
</div>
<div class="Right-Box">
	<center><h5 style="padding:0px; margin:0px;">Buy <?php echo $name;  ?></h5></center>
	<form action="index.php?page=trade&market=<?php echo $id; ?>" method="POST">
		<li>Amount <?phpecho $name;?>:<input type="text" style="width:100px;" onKeyUp="calculateFees2()" name="amount" id="amount2"/></li>
		<li>Price Per: <?phpecho $name;?><input type="text" style="width:100px;" id="price" onKeyUp="calculateFees2()" name="price"/></li>
		<li>Total:<input type="text" style="width:100px;" id="fee2"/></li>
...
<div style="width:100%; height:100%; background:none; border:none; color:#000;" id="contentArea1">
	<?php include("open_orders_from.php");?>
</div>
...
<div style="width:100%; height:100%; background:none; border:none; color:#000;" id="contentArea2">
	<?php include("open_orders_to.php"); ?>
</div>
</div>
<div class="Right-Box" style="background:none; width:100%;">
<div style="width:100%; height:100%; background:none; border:none; color:#000;" id="contentArea2">
	<?php include("cancel_orders.php"); ?>
</div>
</div>
</center>
