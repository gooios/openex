...
mysql_query("INSERT INTO `Logged` (`Username` ,`Time` ,`IP` ,`Action`)VALUES ('$Name', '$Time', '$IP', 'Deleted the group with the id of $bname');
");
mysql_query("DELETE FROM Groups WHERE Group_ID = " . mysql_real_escape_string($_GET["id"]));
