...
mysql_query("INSERT INTO `Logged` (`Username` ,`Time` ,`IP` ,`Action`)VALUES ('$Name', '$Time', '$IP', 'Deleted the Chat with the id of $bname');
");
mysql_query("DELETE FROM Chat WHERE id = " . mysql_real_escape_string($_GET["id"]));
