...
mysql_query("INSERT INTO `Logged` (`Username` ,`Time` ,`IP` ,`Action`)VALUES ('$Name', '$Time', '$IP', 'Deleted the blog named $bname');
");
mysql_query("DELETE FROM Blog WHERE Name = '" . mysql_real_escape_string($_GET["Name"]) . "'");
